...
export default function MobileLandingPageHomeNewFold3() {
  return (
    <div className="home-new-fold3">
      ...
      <section className="home-new-fold3-section1 home-new-fold3-section1--desc">
        ...
        <div className="home-new-fold3-section__desc-block">
          <p>
