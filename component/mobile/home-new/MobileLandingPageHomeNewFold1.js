...
export default function MobileLandingPageHomeNewFold1() {
  return (
    <>
      <div className="home-new-fold1-div">
        <h2 className="home-64-extrabold-font">
          Remote
          <br /> Teams
        </h2>
        <p className="home-30-semiBold-font">
          The Ultimate Set of <br /> Productivity Tools for Tech <br /> Teams
          Working Remotely.
        </p>
        <div className="home-new-fold1-btn-text-row">
